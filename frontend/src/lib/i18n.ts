...
const W: Record<string, Eintrag> = {
  ...
  "ed.teilen": { de: "Am Cursor teilen (Enter; am Textende: neuer Turn)",
    en: "Split at cursor (Enter; at the end of the text: new turn)",
    fr: "Scinder au curseur (Entrée ; en fin de texte : nouveau tour)",
    it: "Dividi al cursore (Invio; a fine testo: nuovo turno)" },
