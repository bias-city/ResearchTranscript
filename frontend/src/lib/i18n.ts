...
const W: Record<string, Eintrag> = {
  ...
  "job.fehler": { de: "Fehler", en: "Error", fr: "Erreur",
    it: "Errore" },
  "ed.play": { de: "Abspielen (K, Leertaste · beim Tippen ⇧Leertaste oder ⌥K, Esc verlässt das Feld · Turn: ↑/↓, beim Tippen ⌥↑/⌥↓)",
    en: "Play (K, Space · while typing ⇧Space or ⌥K, Esc leaves the field · turn: ↑/↓, while typing ⌥↑/⌥↓)",
    fr: "Lecture (K, Espace · en tapant ⇧Espace ou ⌥K, Échap quitte le champ · tour : ↑/↓, en tapant ⌥↑/⌥↓)",
    it: "Riproduci (K, Spazio · digitando ⇧Spazio o ⌥K, Esc lascia il campo · turno: ↑/↓, digitando ⌥↑/⌥↓)" },
  "ed.pause": { de: "Pause (K, Leertaste · beim Tippen ⇧Leertaste oder ⌥K, Esc verlässt das Feld · Turn: ↑/↓, beim Tippen ⌥↑/⌥↓)",
    en: "Pause (K, Space · while typing ⇧Space or ⌥K, Esc leaves the field · turn: ↑/↓, while typing ⌥↑/⌥↓)",
    fr: "Pause (K, Espace · en tapant ⇧Espace ou ⌥K, Échap quitte le champ · tour : ↑/↓, en tapant ⌥↑/⌥↓)",
    it: "Pausa (K, Spazio · digitando ⇧Spazio o ⌥K, Esc lascia il campo · turno: ↑/↓, digitando ⌥↑/⌥↓)" },
