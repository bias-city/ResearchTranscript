...
const W: Record<string, Eintrag> = {
  ...
  "dok.knopf": { de: "Dokumentationspaket (.zip) …", en: "Documentation package (.zip) …",
    fr: "Paquet de documentation (.zip) …", it: "Pacchetto di documentazione (.zip) …" },
  "dok.datei.paket": { de: "dokumentation", en: "documentation", fr: "documentation", it: "documentazione" },
  "st.turnfamilie": { de: "Schriftart Turn-Text", en: "Turn text typeface",
    fr: "Police du texte des tours", it: "Carattere del testo dei turni" },
  "st.turnfamilie.sans": { de: "Serifenlos (System)", en: "Sans serif (system)",
    fr: "Sans empattement (système)", it: "Senza grazie (sistema)" },
  "st.turnfamilie.serif": { de: "Serifen (New York)", en: "Serif (New York)",
    fr: "Avec empattement (New York)", it: "Con grazie (New York)" },
