...
const W: Record<string, Eintrag> = {
  ...
  "dok.knopf": { de: "Dokumentation …", en: "Documentation …", fr: "Documentation …", it: "Documentazione …" },
  "dok.titel": { de: "Dokumentation für Forschende", en: "Documentation for researchers",
    fr: "Documentation pour la recherche", it: "Documentazione per la ricerca" },
  "dok.text": {
    de: "Aus den echten Werten deiner Transkripte erzeugt: welche Modelle liefen, wie stark von Hand bearbeitet wurde. Was nur du weisst, bleibt als offenes Feld [ … ] stehen.",
    en: "Generated from the real values of your transcripts: which models ran, how much was edited by hand. What only you know stays as an open field [ … ].",
    fr: "Généré à partir des valeurs réelles de tes transcriptions : quels modèles ont tourné, quelle part a été modifiée à la main. Ce que toi seul·e sais reste un champ ouvert [ … ].",
    it: "Generato dai valori reali delle tue trascrizioni: quali modelli sono stati usati, quanto è stato modificato a mano. Ciò che sai solo tu resta un campo aperto [ … ]." },
  "dok.auswahl.n": { de: "Für {n} angekreuzte Transkripte.", en: "For {n} ticked transcripts.",
    fr: "Pour {n} transcriptions cochées.", it: "Per {n} trascrizioni selezionate." },
  "dok.auswahl.alle": { de: "Nichts angekreuzt: für alle {n} Transkripte der Bibliothek.",
    en: "Nothing ticked: for all {n} transcripts in the library.",
    fr: "Rien de coché : pour les {n} transcriptions de la bibliothèque.",
    it: "Nessuna selezione: per tutte le {n} trascrizioni della biblioteca." },
  "dok.waehlen": { de: "Für die Dokumentation auswählen", en: "Select for documentation",
    fr: "Sélectionner pour la documentation", it: "Seleziona per la documentazione" },
  "dok.paket": { de: "Alles als Paket", en: "Everything as a package", fr: "Tout en un paquet", it: "Tutto in un pacchetto" },
  "dok.paket.text": {
    de: "Alle Dokumente unten als .md und .docx, die Transkriptionsprotokolle je Transkript und die Zitierdatei — in einem Zip. Ohne Transkripte und Aufnahmen.",
    en: "All documents below as .md and .docx, the transcription record of each transcript and the citation file — in one zip. No transcripts, no recordings.",
    fr: "Tous les documents ci-dessous en .md et .docx, le protocole de chaque transcription et le fichier de citation — dans un zip. Sans transcriptions ni enregistrements.",
    it: "Tutti i documenti qui sotto in .md e .docx, il protocollo di ogni trascrizione e il file di citazione — in uno zip. Senza trascrizioni né registrazioni." },
  "dok.methoden": { de: "Methodenbaustein", en: "Methods building block", fr: "Module méthodologique", it: "Modulo metodologico" },
  "dok.methoden.text": {
    de: "Das Korpus in Zahlen, Korrekturrate und neu zugeordnete Sprechzeit (Median, Spanne), ein Absatz für den Methodenteil mit Nachweisen.",
    en: "The corpus in numbers, correction rate and reassigned speech time (median, range), a paragraph for the methods section with references.",
    fr: "Le corpus en chiffres, taux de correction et temps de parole réattribué (médiane, étendue), un paragraphe pour la partie méthodes avec références.",
    it: "Il corpus in cifre, tasso di correzione e tempo di parola riassegnato (mediana, intervallo), un paragrafo per la sezione metodi con riferimenti." },
  "dok.repositorium": { de: "Repositoriums-Datenblatt", en: "Repository data sheet",
    fr: "Fiche de dépôt", it: "Scheda per il deposito" },
  "dok.repositorium.text": {
    de: "Felder nach Zenodo/DataCite und den Facharchiven, vorausgefüllt aus Zotero und den Transkripten, mit Dateiliste, Prüfsummen und Ethik-Checkliste.",
    en: "Fields after Zenodo/DataCite and the specialised archives, pre-filled from Zotero and the transcripts, with file list, checksums and ethics checklist.",
    fr: "Champs selon Zenodo/DataCite et les archives spécialisées, préremplis depuis Zotero et les transcriptions, avec liste de fichiers, sommes de contrôle et liste éthique.",
    it: "Campi secondo Zenodo/DataCite e gli archivi specializzati, precompilati da Zotero e dalle trascrizioni, con elenco dei file, checksum e lista etica." },
  "dok.verfahren": { de: "Verfahrensbaustein", en: "Processing building block",
    fr: "Module pour le registre des traitements", it: "Modulo per il registro dei trattamenti" },
  "dok.verfahren.text": {
    de: "Für Verzeichnis der Bearbeitungstätigkeiten, Folgenabschätzung und Ethikantrag: was die App tut und nicht tut; offene Felder für die verantwortliche Stelle.",
    en: "For records of processing, DPIA and ethics application: what the app does and does not do; open fields for the controller.",
    fr: "Pour le registre des traitements, l’analyse d’impact et la demande éthique : ce que l’app fait et ne fait pas ; champs ouverts pour le responsable.",
    it: "Per il registro dei trattamenti, la valutazione d’impatto e la domanda etica: cosa fa e non fa l’app; campi aperti per il titolare." },
  "dok.zitate": { de: "Zitierdatei für Zotero", en: "Citation file for Zotero",
    fr: "Fichier de citation pour Zotero", it: "File di citazione per Zotero" },
  "dok.zitate.text": {
    de: "ResearchTranscript als Eintrag «Software», dazu Whisper, pyannote und die übrigen Quellen. In Zotero: Datei › Importieren.",
    en: "ResearchTranscript as a “Software” item, plus Whisper, pyannote and the other sources. In Zotero: File › Import.",
    fr: "ResearchTranscript comme entrée « Logiciel », plus Whisper, pyannote et les autres sources. Dans Zotero : Fichier › Importer.",
    it: "ResearchTranscript come voce «Software», più Whisper, pyannote e le altre fonti. In Zotero: File › Importa." },
  "dok.protokoll.hinweis": {
    de: "Das Transkriptionsprotokoll eines einzelnen Transkripts findest du im Editor unter Export.",
    en: "The transcription record of a single transcript is in the editor under Export.",
    fr: "Le protocole d’une seule transcription se trouve dans l’éditeur, sous Export.",
    it: "Il protocollo di una singola trascrizione si trova nell’editor, sotto Esporta." },
  "dok.datei.paket": { de: "researchtranscript-dokumentation", en: "researchtranscript-documentation",
    fr: "researchtranscript-documentation", it: "researchtranscript-documentazione" },
  "dok.datei.methoden": { de: "methodenbaustein-transkription", en: "methods-transcription",
    fr: "module-methodologique-transcription", it: "modulo-metodologico-trascrizione" },
  "dok.datei.repositorium": { de: "repositoriums-datenblatt", en: "repository-data-sheet",
    fr: "fiche-de-depot", it: "scheda-deposito-repository" },
  "dok.datei.verfahren": { de: "verfahrensbaustein-researchtranscript", en: "processing-building-block-researchtranscript",
    fr: "module-registre-researchtranscript", it: "modulo-registro-researchtranscript" },
  "dok.datei.zitate": { de: "researchtranscript", en: "researchtranscript", fr: "researchtranscript", it: "researchtranscript" },
  "ed.export.protokoll": { de: "Transkriptionsprotokoll", en: "Transcription record",
    fr: "Protocole de transcription", it: "Protocollo di trascrizione" },
  "ed.export.protokoll.datei": { de: "protokoll", en: "record", fr: "protocole", it: "protocollo" },
