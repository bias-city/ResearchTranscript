    ...
    <Flex style={{ height: "100%", minHeight: 0 }}>
      <Flex direction="column"
        ...
        <Flex align="center" gap="2" px="4" py="2"
          ...
          <Button size="1" variant="soft" color="gray" highContrast onClick={onExit}>
    ...
    return (
      <Flex direction="column" gap="3" p="3">
        ...
        <Flex gap="2" wrap="wrap">
          ...
          <Button size="1" variant="soft" color="gray" highContrast disabled={laeuft}
  ...
  return (
    <Flex direction="column" gap="3" p="3">
      <Flex gap="2">
        ...
        <Button variant="soft" color="gray" highContrast size="1" onClick={() => void suche()}
      ...
      {wahl && (
        <Flex direction="column" gap="2" p="2"
          ...
          <Button variant="soft" color="gray" highContrast size="1" disabled={laeuft}
...
function ExportMenu({ onExport, hatVideo }: {
  ...
  return (
    ...
    <Select.Root value="" size="1" onValueChange={(v) => v && onExport(v)}>
      <Select.Trigger placeholder={tr("ed.export")} variant="soft" color="gray" />
...
function SprecherPanel({ id, sprecher, segmente, hatAudio, onRename,
  ...
  return (
    ...
    <Flex direction="column" gap="2" px="4" py="3"
      ...
      <Button size="1" variant="soft" color="gray" highContrast onClick={onNeu}>
    ...
    <Flex direction="column" gap="3" px="4" py="3">
      ...
      <Flex direction="column" gap="2" align="start">
        <Flex gap="2" align="center">
          <Button size="1" variant="soft" color="gray" highContrast disabled={!cur}
                  onClick={ersetzen}>{tr("ed.suche.ersetzen")}</Button>
          <Button size="1" variant="soft" color="gray" highContrast disabled={treffer.length < 2}
                  onClick={() => springe(stelle + 1)}>
            {tr("ed.suche.skip")}</Button>
        </Flex>
        <Button size="1" variant="soft" color="gray" highContrast disabled={!treffer.length}
