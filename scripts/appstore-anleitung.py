...
Mac with Apple silicon, macOS 14 or later, about 2 GB of free space.""",
    ...
    "fr": {
        ...
        "werbetext": "Un enregistrement en entrée, une transcription avec locuteurs en sortie — sur votre Mac, sans cloud ni compte. Pour entretiens, groupes de discussion et terrains.",
        ...
        "beschreibung": """ResearchTranscript transcrit entretiens, discussions de groupe et enregistrements de terrain entièrement sur votre Mac. L’enregistrement ne quitte jamais l’ordinateur : pas de cloud, pas de compte, aucune connexion réseau.
...
• Séparation des locuteurs sur le Neural Engine : indiquez le nombre de personnes par enregistrement ou laissez l’application le détecter
• Glissez plusieurs fichiers dans la liste d’attente, choisissez le nombre de locuteurs par fichier, lancez — la liste survit à un redémarrage
• Vidéo (MP4, MOV en H.264 ou HEVC) comme source : le son est lu, l’image suit en silence dans l’éditeur
• Vos propres modèles whisper.cpp, par exemple un modèle affiné pour le suisse allemand, se déposent dans le dossier des modèles
...
• Sur demande, métadonnées de votre bibliothèque Zotero locale : titre, date, enquêteurs, clé de citation
